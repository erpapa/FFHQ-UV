...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--network_pkl',
                            type=str,
                            default='/data/deep/FFHQ/FFHQ/checkpoints/stylegan_model/stylegan2-ffhq-config-f.pkl')
        parser.add_argument('--max_result_snapshots', default=30, help='max result snapshots')

        parser.add_argument(
            "--proj_data_dir",
            type=str,
            default='/data/deep/FFHQ/FFHQ/examples/test_examples',
        ...
        parser.add_argument("--flow_model_path",
                            type=str,
                            default='/data/deep/FFHQ/FFHQ/checkpoints/styleflow_model/modellarge10k.pt',
                            help="The path of the pretrained styleflow model.")
        parser.add_argument("--exp_direct_path",
                            type=str,
                            default='/data/deep/FFHQ/FFHQ/checkpoints/styleflow_model/expression_direction.pt',
                            help="The path of the expression direction.")
        parser.add_argument("--exp_recognition_path",
                            type=str,
                            default='/data/deep/FFHQ/FFHQ/checkpoints/exprecog_model/FacialExpRecognition_model.t7',
